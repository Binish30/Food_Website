...
import BiryaniImg1 from "../../assets/biryani4.png";
        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
                Dive into a culinary adventure with our carefully crafted
                dishes, featuring a perfect blend of traditional flavors and
                modern twists. Whether you're here for a quick bite or a full
                feast, we promise to satisfy every craving.
              </p>
              <div>
              </div>
            </div>
